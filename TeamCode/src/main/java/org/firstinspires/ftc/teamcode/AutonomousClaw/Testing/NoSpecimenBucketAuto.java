...
import org.firstinspires.ftc.teamcode.AutonomousClaw.Normal.AdvancedBucketAutoRed;
import org.firstinspires.ftc.teamcode.DefaultRRFiles.MecanumDrive;

@Autonomous(name = "BucketAutoTwo")
public class NoSpecimenBucketAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Actions.runBlocking(new SequentialAction(
                drive.actionBuilder(new Pose2d(-8, -60, Math.toRadians(90)))
                        //score preload
                        .strafeToLinearHeading(new Vector2d(-50, -56), Math.toRadians(215))
                        .waitSeconds(.5)
                        .lineToX(-51)
                        .waitSeconds(.5)
                        //score second sample
                        ...
                        //score sample
                        .strafeToLinearHeading(new Vector2d(-50, -56), Math.toRadians(215))
                        .strafeToLinearHeading(new Vector2d(-51, -57), Math.toRadians(215))
                        .lineToX(-50)
                        .waitSeconds(.5)
                        //score fourth sample
                        //pick up sample
...
//                        .stopAndAdd(new NoSpecimenBucketAuto.ClawRelease(ClawGrab, .65))
//                        .stopAndAdd(new NoSpecimenBucketAuto.ClawAngle(ClawTurn, .52))
//                        .stopAndAdd(new NoSpecimenBucketAuto.ArmAngle(angMotor, 2650))
//                        .waitSeconds(.5)
//                        .waitSeconds(.5)
//                        .stopAndAdd(new NoSpecimenBucketAuto.ArmExtension(extendMotor, 1320))
//                        .waitSeconds(1.5)
//                        .stopAndAdd(new NoSpecimenBucketAuto.ClawRelease(ClawGrab, 0.55))
//                        .waitSeconds(.5)
//                        .lineToYConstantHeading(-32)
//                        .stopAndAdd(new NoSpecimenBucketAuto.ArmExtension(extendMotor, 0))
//                        .stopAndAdd(new NoSpecimenBucketAuto.ArmAngle(angMotor, -1375))
//                        .stopAndAdd(new NoSpecimenBucketAuto.ClawAngle(ClawTurn, .5))
//                        .waitSeconds(.5)
//                        .lineToYConstantHeading(-35)
//                        //score first sample
//                        //pick up sample
//                        .splineToConstantHeading(new Vector2d(-48, -56), Math.toRadians(90))
//                        .stopAndAdd(new NoSpecimenBucketAuto.ArmExtension(extendMotor, 2000))
//                        .stopAndAdd(new NoSpecimenBucketAuto.ClawRelease(ClawGrab, .65))
//                        .waitSeconds(.75)
//                        .stopAndAdd(new NoSpecimenBucketAuto.ClawAngle(ClawTurn, .5))
//                        .stopAndAdd(new NoSpecimenBucketAuto.ArmAngle(angMotor, 3800))
//                        .waitSeconds(1.5)
//                        .stopAndAdd(new NoSpecimenBucketAuto.ArmExtension(extendMotor, 2900))
//                        .waitSeconds(1.5)
//                        //score sample
//                        .turn(2.1)
//                        .lineToX(-50)
//                        .stopAndAdd(new NoSpecimenBucketAuto.ClawRelease(ClawGrab, .55))
//                        .waitSeconds(.5)
//                        //score second sample
//                        //pick up sample
//                        .strafeToLinearHeading(new Vector2d(-58, -50), Math.toRadians(90))
...
//                        .waitSeconds(.5)
//                        .stopAndAdd(new NoSpecimenBucketAuto.ArmExtension(extendMotor, 0))
//                        .stopAndAdd(new NoSpecimenBucketAuto.ArmAngle(angMotor, 0))
//                        .stopAndAdd(new NoSpecimenBucketAuto.ClawRelease(ClawGrab, .65))
//                        .stopAndAdd(new NoSpecimenBucketAuto.ClawAngle(ClawTurn, .5))
                        .build()));
    }
